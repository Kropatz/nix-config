{
  ...
  systemd.services = {
    ...
    samba-winbindd.serviceConfig = {
      ...
      CapabilityBoundingSet = "CapabilityBoundingSet=~CAP_BLOCK_SUSPEND CAP_BPF CAP_CHOWN CAP_IPC_LOCK CAP_MKNOD CAP_NET_RAW CAP_PERFMON CAP_SYS_BOOT CAP_SYS_CHROOT CAP_SYS_MODULE CAP_SYS_NICE CAP_SYS_PACCT CAP_SYS_PTRACE CAP_SYS_TIME CAP_SYSLOG CAP_WAKE_ALARM";
      ProtectSystem = "full";
      ProtectHome = true;
      PrivateDevices = true;
      PrivateMounts = true;
